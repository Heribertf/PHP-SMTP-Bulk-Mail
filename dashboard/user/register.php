                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="reg-form">
                        <label class="block text-sm">
                            ...
                            <input
                                ...
                                placeholder="Enter your first name" type="text" id="first_name" name="first_name"
                                required />
                        </label>
                        <label class="block mt-4 text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Enter your last name" type="text" id="last_name" name="last_name"
                                required />
                        </label>
                        <label class="block mt-4 text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Enter a valid email address" type="email" id="email_address"
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Choose your preferred username" type="text" id="username" name="username"
                                required />
                        </label>
                        <label class="block mt-4 text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Type your password" type="password" id="password" name="password"
                                required />
                        </label>
                        <label class="block mt-4 text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Confirm your password" type="password" id="conf_password"
